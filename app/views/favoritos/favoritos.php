...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="input-group search-bar">
            ...
            <input type="text" id="buscadorConvocatorias" class="form-control bg-transparent border-0" 
                 ...
                 <div class="col-md-6 col-lg-4 tarjeta-convocatoria" data-index="<?= $index ?>">
                        <div class="card h-100 shadow-sm">
                            <div class="position-relative">
                                <img src="/img/image.png" class="card-img-top" alt="<?php echo htmlspecialchars($conv->nombre) ?>" style="height: 180px; object-fit: cover;">
 ...
 document.addEventListener("DOMContentLoaded", function () {
        ...
        function mostrarTarjetasPorPagina() {
            const valorSeleccionado = selectItemsPorPagina.value;

            tarjetas.forEach((tarjeta, index) => {
                // Si se selecciona "todos", se muestran todas
                if (valorSeleccionado === "todos") {
                    tarjeta.style.display = "block";
                } else {
                    const cantidad = parseInt(valorSeleccionado);
                    tarjeta.style.display = (index < cantidad) ? "block" : "none";
                }
            });
        }

        // Mostrar las tarjetas correctas al cargar
        mostrarTarjetasPorPagina();

        // Escuchar cambios en el <select>
        selectItemsPorPagina.addEventListener("change", mostrarTarjetasPorPagina);
    });
    </script>
    ...
    <script src="/js/eliminarFavoritos.js"></script>
