...
<div class="container py-5">
    <div class="card shadow-lg border-0 rounded-4">
        ...
        <div class="card-header bg-gradient bg-success text-white p-4 rounded-top-4 d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fs-3 fw-bold mb-1">REQUISITOS</h2>
                <p class="text-white-50 text-uppercase mb-0 fs-7">Gestión documental</p>
            </div>
            <div class="text-end">
                <div class="progress bg-white bg-opacity-25 rounded-pill mb-2" style="height: 10px; width: 160px;">
                    <div class="progress-bar bg-white" role="progressbar" style="width: 0%;" 
                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="badge bg-white text-success fw-semibold rounded-pill px-3 py-1 fs-7">
        ...
        <div class="card-body p-4">
            ...
            <?php if (isset($tipos) && !empty($tipos)): ?>
                <ul class="nav nav-tabs mb-3" id="requisitosTab" role="tablist">
                    <?php $active = true; foreach ($tipos as $index => $tipo): ?>
                ...
                <div class="tab-content" id="requisitosTabContent">
                    <?php $active = true; foreach ($tipos as $tipo): ?>
        ...
        <div class="card-footer d-flex justify-content-between p-4 bg-light">
            <div>
                <a href="/userPerfil/init" class="btn btn-outline-secondary rounded-pill px-4">
